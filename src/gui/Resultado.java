...
public class Resultado extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (data[data.length-1][data[0].length-1] == Double.POSITIVE_INFINITY) {
          this.dispose();
          JOptionPane.showMessageDialog(null, "No se puede devolver cambio", "Lo sentimos", JOptionPane.DEFAULT_OPTION);
